...
export type ResourceManager = RestManager | GqlManager | LocalManager;

export type QueryParameters = Partial<
  Parameters<GqlManager["client"]["query"]>
>;
export type QueryReturnType = Promise<
  ReturnType<GqlManager["client"]["query"]> | any
>;
